...
<div class="body">	
	...
	<div class="div ex-p-4 ex-rounded bg-white">
		...
		<h1 class="ex-display-3 text-center">Modification de l'adresse e-mail pour votre compte <?= ucfirst(WEBSITE_NAME) ?></h1>

		<p class="ex-p-4">Hey <a href><?= $ex_username ?></a>,</p>

		<p>
			L'adresse e-mail de votre compte <?= ucfirst(WEBSITE_NAME) ?>, a récemment été modifié.
		</p>

		<p>Si vous avez effectué ce changement, alors vous êtes prêt.</p><br><br>

		<p>
			Vous n'avez pas changé d'adresse e-mail?<br>
		...
		<ol class="ex-p-4">
			...
			<li>
				...
				<small><a href="<?= WURI . '/reset/user/' .  $userInfos->hashedID; ?>">Récupérer mon compte</a></small>
				<br><br>
			</li>

			<li>
				Passez en revue vos numéros de téléphone et adresses électroniques et supprimez ceux qui ne vous appartiennent pas.<br>
				<small><a href="<?= WURI . '/account/security/' .  $userInfos->hashedID . '/check'; ?>">Passer en revue</a></small>
			</li>
