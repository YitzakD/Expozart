...
--
-- Hôte : 127.0.0.1
-- Généré le :  sam. 25 jan. 2020 à 17:01
...
CREATE TABLE `ex_arts` (
  ...
  `arthash` varchar(20) NOT NULL,
  `created` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Stock les artworks';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Stock les tokens pour les sessions des utilisateurs';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Stock les différentes catégories pour les topics et les artw';
...
CREATE TABLE `ex_comments` (
  ...
  `uID` int(11) NOT NULL,
  `aID` int(11) NOT NULL,
  `cTYPE` enum('1','2') NOT NULL COMMENT '1 = Artwork critic | 2 = Comment criitic',
  `commentbody` longtext NOT NULL,
  `criticID` int(11) NOT NULL COMMENT 'ID de la critic à commenter',
  `created` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Stock les critiques des utilisteurs';
...
(2, 2, 12, '1', 'goo jobs', 0, '2019-11-27 01:07:03'),
(3, 1, 12, '1', 'merci!', 0, '2019-11-27 01:08:16'),
(4, 2, 12, '1', 'De rien frÃ¨re, j\'adore ton taf!', 0, '2019-11-27 01:08:49'),
(5, 1, 12, '1', 'Cool', 0, '2019-11-27 01:09:01'),
(6, 2, 12, '1', 'Chui content que tu sois sur expozart', 0, '2019-11-27 01:09:30'),
(7, 1, 12, '1', 'Moi aussi', 0, '2019-11-27 01:09:44'),
(8, 1, 12, '1', 'C\'est une trÃ¨s bonne plateforme qui met en valeur nos traveaux.', 0, '2019-11-27 01:11:01'),
(9, 2, 12, '1', 'Oui, en tout cas, c\'est du bon', 0, '2019-11-27 01:11:23'),
(10, 1, 12, '1', 'ok cool', 0, '2019-11-27 01:11:36'),
(11, 1, 12, '1', 'Wep, bon Ã  plus', 0, '2019-11-27 01:11:50');
...
CREATE TABLE `ex_contry` (
  `ID` int(11) NOT NULL,
  `contrynamme` varchar(100) NOT NULL,
  `contrycode` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Stcok la liste des pays';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Stock les différentes langues disponible';
...
CREATE TABLE `ex_likes` (
  ...
  `uID` int(11) NOT NULL,
  `aID` int(11) NOT NULL,
  `lTYPE` enum('1','2') NOT NULL COMMENT '1 = Artwork like | 2 = Criitic like',
  `criticID` int(11) NOT NULL COMMENT 'ID de a critique Liker',
  `created` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Stock les likes des utilisateurs sous les artworks';
...
(1, 1, 13, '1', 0, '2019-11-27 00:05:21'),
(2, 2, 13, '1', 0, '2019-11-27 01:04:03'),
(3, 2, 12, '1', 0, '2019-11-27 01:04:15');
...
CREATE TABLE `ex_media` (
  ...
  `fileusability` enum('0','1','2') NOT NULL COMMENT '0 = PP | 1 = Artwork Cover | 2 = Category Cover'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Stock les différents medias attachés';
...
CREATE TABLE `ex_topics` (
  ...
  `created` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Stock les topics des utilisateurs';
...
(6, 1, 6, 'LittÃ©rature', '2019-11-09 21:13:00', '2019-11-09 21:13:00'),
(7, 1, 7, 'PoÃ©sie', '2019-11-09 21:13:00', '2019-11-09 21:13:00'),
(8, 1, 8, 'ThÃ©Ã¢tre', '2019-11-09 21:13:00', '2019-11-09 21:13:00'),
(9, 1, 9, 'Danse', '2019-11-09 21:13:00', '2019-11-09 21:13:00'),
(10, 1, 10, 'CinÃ©ma', '2019-11-09 21:13:00', '2019-11-09 21:13:00'),
(11, 1, 11, 'TÃ©lÃ©vision', '2019-11-09 21:13:00', '2019-11-09 21:13:00'),
(12, 1, 12, 'Radiodiffusion', '2019-11-09 21:13:00', '2019-11-09 21:13:00'),
(13, 1, 13, 'Photographie', '2019-11-09 21:13:00', '2019-11-09 21:13:00'),
(14, 1, 14, 'Bande dessinÃ©e', '2019-11-09 21:13:00', '2019-11-09 21:13:00'),
(15, 1, 15, 'Comics', '2019-11-09 21:13:00', '2019-11-09 21:13:00'),
(16, 1, 16, 'Mangas', '2019-11-09 21:13:00', '2019-11-09 21:13:00'),
(17, 1, 17, 'Jeux-vidÃ©os', '2019-11-09 21:13:00', '2019-11-09 21:13:00'),
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Stock les agrégations des utilisateurs';
...
CREATE TABLE `ex_userfollowing` (
  ...
  `rID` int(11) NOT NULL,
  `created` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Stock les affiliations entre les utilisateurs';
...
CREATE TABLE `ex_userinfos` (
  ...
  `gender` enum('0','1','6') NOT NULL COMMENT '0 = Female | 1 = Male | 6 = Others or Undefined',
  `phone` int(11) NOT NULL,
  `about` longtext NOT NULL,
  `weblink` varchar(225) NOT NULL,
  `localisation` longtext NOT NULL,
  `city` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Stock les informations privées des utilisateurs';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Stock la date de la dernière des utilisateurs';
...
CREATE TABLE `ex_userprefs` (
  `ID` int(11) NOT NULL,
  `uID` int(11) NOT NULL,
  `lID` int(11) NOT NULL COMMENT 'ID de la langue',
  `style` enum('1','0') NOT NULL COMMENT '1 = Normal mode style | 0 = Dark mode style',
  `session` enum('0','1') NOT NULL COMMENT '0 = Not saved session | 1 = Saved session'
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Stock les différents état d''un compte';
...
CREATE TABLE `ex_usertopics` (
  ...
  `cID` int(11) NOT NULL,
  `tID` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Stock les affiliations entre les utilisateurs et les topics';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Stock les types d''utilisateurs';
...
ALTER TABLE `ex_arts`
  ADD PRIMARY KEY (`ID`),
  ADD UNIQUE KEY `arthash` (`arthash`);
...
ALTER TABLE `ex_users`
  ...
  ADD UNIQUE KEY `hashedID` (`hashedID`);
